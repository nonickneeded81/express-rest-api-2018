...
const exportSingleM = (builder: Builder, model: Model) => {
  return (i: number = 0, modifier: Modifier = {}) => singleM(builder, model, i, modifier);
};

const exportMultiM = (builder: Builder, model: Model) => {
  return (_range: number = 5, modifier: Modifier = {}) => multiM(builder, model, _range, modifier);
};

const exportSingle = (builder: Builder, model: Model) => {
  return (i: number = 0, modifier: Modifier = {}) => single(builder, model, i, modifier);
};

const exportMulti = (builder: Builder, model: Model) => {
  return (_range: number = 5, modifier: Modifier = {}) => multi(builder, model, _range, modifier);
};
